...
func TestOneKey(t *testing.T) {
	...
	if !strings.HasPrefix(string(cipher[:]), key+":v1:") {
...
func serviceTestFactory(config, url string, keys ...string) (*VaultEnvelopeService, error) {
